...
class CarroDAO
{
   ...
   {
      $dsn = 'mysql:host=localhost:3306;dbname=db_mvc_car';
   ...
   public function insert(CarroModel $model)
   {
      ...
      $sql = "INSERT INTO carros (Marca, nomeCarro, Quilometros, Ano) VALUE(?, ?, ?, ?)";
   ...
   {
      $sql = "UPDATE carros SET Marca=?, nomeCarro=?, Quilometro=?, Ano=? WHERE id=? ";
